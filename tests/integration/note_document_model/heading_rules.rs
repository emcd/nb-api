...
// ---------- terminal Tags after Content/Source ----------

/// Frozen scenario: Tags terminal AFTER Content
...
///
/// This case was previously untested; an earlier implementation
...
// ---------- HeadingRole section-boundary vs internal-body ----------

/// The layered pipeline replaces the boolean
...
// ---------- Negative regressions for non-exact reserved headings ----------
...
// ---------- EOF-unterminated regression coverage ----------
...
// ---------- Todo exact-candidate role check ----------
...
/// normalized heading text is `Tags`. Under the exact-form rule,
